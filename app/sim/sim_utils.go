...
import (
	...
	omniflixhub "github.com/OmniFlix/onft/app"
...
func SimulationOperations(app *omniflixhub.App, cdc codec.JSONCodec, config simtypes.Config) []simtypes.WeightedOperation {
