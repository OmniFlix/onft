...
import (
	...
	"github.com/OmniFlix/onft/app/helpers"
...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/cosmos/cosmos-sdk/OnftApp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
...
func TestFullAppSimulation(t *testing.T) {
	...
	app := New(logger, db, nil, true, map[int64]bool{}, DefaultNodeHome, simapp.FlagPeriodValue, MakeEncodingConfig(), helpers.EmptyAppOptions{}, fauxMerkleModeOpt)
