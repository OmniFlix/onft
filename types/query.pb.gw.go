...
var (
	...
	pattern_Query_IBCCollection_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"omniflix", "onft", "v1beta1", "collections", "ibc", "hash"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	pattern_Query_IBCDenom_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"omniflix", "onft", "v1beta1", "denoms", "ibc", "hash"}, "", runtime.AssumeColonVerbOpt(true)))
