...
type Params struct {
	DenomCreationFee []github_com_cosmos_cosmos_sdk_types.Coin `protobuf:"bytes,1,rep,name=denom_creation_fee,json=denomCreationFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Coin" json:"denom_creation_fee" yaml:"denom_creation_fee"`
}
...
var fileDescriptor_fcc80a6d9232b72d = []byte{
	...
	0x99, 0x9f, 0x17, 0x9f, 0x96, 0x9a, 0x2a, 0xc1, 0xa8, 0xc0, 0xac, 0xc1, 0x6d, 0x24, 0xa9, 0x07,
	...
	0x38, 0xf0, 0xc0, 0x36, 0x26, 0xb1, 0x81, 0xfd, 0x69, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x60,
	0x68, 0xd0, 0x5e, 0x51, 0x01, 0x00, 0x00,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DenomCreationFee) > 0 {
		for iNdEx := len(m.DenomCreationFee) - 1; iNdEx >= 0; iNdEx-- {
			{
				size := m.DenomCreationFee[iNdEx].Size()
				i -= size
				if _, err := m.DenomCreationFee[iNdEx].MarshalTo(dAtA[i:]); err != nil {
					return 0, err
				}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.DenomCreationFee = append(m.DenomCreationFee, github_com_cosmos_cosmos_sdk_types.Coin{})
